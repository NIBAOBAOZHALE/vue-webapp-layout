        ...
        gridData: [
          {
            name: '全场通用20元代金券',
            count: '20',
            img: require('toAssets/img/ticket.png')
          },
          {
            name: 'YSL 003色号',
            count: '342.09',
            img: require('toAssets/img/purchase-e-ticket-by-bulk-purchase-form.png')
          },
          {
            name: '百草味坚果礼盒代金劵3',
            count: '20000',
            img: require('toAssets/img/points-mall.png')
          }
        ],
        ticketList: [],
        input: '',
