<template>
  <div class="main-container image-hot-spot-area">
    <div class="left-box">
      ...
      <!--        class="handle-box"-->
      <!--        v-if="-->
      <!--          currentEditHotSpotObj !== undefined || currentEditHotSpotObj !== null-->
      <!--        "-->
      <!--      >-->
      <!--        <el-form-->
      <!--          :label-position="'left'"-->
      ...
      <!--            <url-selector-with-prod-selector-for-hot-spot-->
      <!--              v-if="currentEditHotSpotObj"-->
      <!--              :after-link-change="receiveLink()"-->
      <!--              :link="-->
      <!--                currentEditHotSpotObj.link-->
      <!--                  ? currentEditHotSpotObj.link.miniUri ||-->
      <!--                    currentEditHotSpotObj.link.webUri-->
      <!--                  : ''-->
      <!--              "-->
      <!--            ></url-selector-with-prod-selector-for-hot-spot>-->
      <!--          </el-form-item>-->
      <!--          <el-form-item label="热点名称" style="width: calc(100% - 80px);">-->
      <!--            <el-input-->
      <!--              v-if="currentEditHotSpotObj != null"-->
      <!--              v-model="objArr[currentEditHotSpotIndex].name"-->
      <!--              :placeholder="'热点' + (currentEditHotSpotIndex + 1)"-->
      <!--              @input="postArr"-->
      <!--            ></el-input>-->
      <!--          </el-form-item>-->
      <!--        </el-form>-->
    ...
    watch: {
      objArr: {
        handler: function() {
          ...
          //   );
          //   obj.x = this.$lodash.floor((obj.absolute.x / this.parentWidth) * 100);
          //   obj.y = this.$lodash.floor(
          //     (obj.absolute.y / this.parentHeight) * 100
          //   );
          // }
